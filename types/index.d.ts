...
declare namespace fu {
  ...
  interface FuStatic {
     ...
     * // => ['http://hello.com/a.jpg', 'http://hello.com/b.jpg', 'http://hello.com/c.jpg']
     */
    addAssetsBaseUrl(source: Array<string>, key: boolean, baseUrl: string): Array<string>
     ...
     * // => [{src: 'http://hello.com/a.jpg'}, {src: 'http://hello.com/b.jpg'}, {src: 'http://hello.com/c.jpg'}]
     */
    addAssetsBaseUrl<T extends addAssetsBaseUrlSource>(source: Array<T>, key: string, baseUrl: string): Array<T>
     ...
     * => { src: 'http://test.com/a.jpg' }
     */
    addAssetsBaseUrl<T extends addAssetsBaseUrlSource>(source: T, key: string, baseUrl: string): T
  }
}
...
declare namespace fu {
  interface FuStatic {
     ...
     * [ `fu.deepClone` ]
     */
    hideSourceName<T extends object | Array<object>, K extends object>(sourceObj: T, hideKeyMap: K): T
  }
}
...
declare namespace fu {
  interface FuStatic {
     ...
     */
    obj2UrlQuery<T extends object>(param: T, key?: string, encode?: boolean): string
  }
}
...
declare namespace fu {
  ...
  interface FuStatic {
     ...
     */
    sourceNameConversion<T extends object, K extends object, >(sourceObj: T, translateMap: K, type?: sourceNameConversionKey): T
  }
}
